    ...
    >
      ...
      <div onClick={handleNavigateToBriefing} className="relative w-full aspect-[16/10] sm:aspect-[4/3] bg-slate-950 overflow-hidden cursor-pointer">
        {!imgError ? (
          <motion.img
            ...
            src={optimizeImage(posterUrl, { width: 400 })}
            srcSet={buildSrcSet(posterUrl)}
      ...
      <div className="p-3 sm:p-4 flex-grow flex flex-col justify-between">
        ...
        <div className={`mt-4 pt-3 border-t flex items-center justify-between gap-1 xs:gap-2 ${isDarkMode ? "border-white/[0.04]" : "border-slate-100"}`}>
          ...
          <div className="flex flex-wrap gap-1 max-w-[36%] items-center select-none overflow-hidden shrink min-w-0">
            {isEventOrPlay ? (
          ...
          <div className="flex items-center gap-1 sm:gap-1.5 shrink-0">
            ...
            <motion.button
              ...
              className={`shrink-0 px-2.5 max-[350px]:px-1.5 py-1.5 text-[10px] min-[360px]:text-[11px] font-black rounded-xl transition-all shadow-md cursor-pointer focus:outline-none text-center whitespace-nowrap select-none ${
                isDarkMode 
