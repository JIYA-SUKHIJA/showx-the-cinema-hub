...
export default function DataTable({ columns, data, isDarkMode, onDelete }) {
  // New functionality: State for Bulk Selection
  ...
  // New functionality: Status Badge helper
        ...
        <table className="w-full text-left border-collapse">
          <thead className={`sticky top-0 z-10 ${isDarkMode ? "bg-slate-900 border-b border-white/[0.08]" : "bg-slate-50 border-b border-slate-200"}`}>
            <tr>
              ...
              {onDelete && <th className="p-4 text-right font-bold uppercase text-[10px] tracking-widest text-slate-500">Actions</th>}
            </tr>
          </thead>
