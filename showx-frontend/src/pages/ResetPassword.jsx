      ...
      {!isSubmitted ? (
            ...
            <div className="space-y-1">
              <div className="relative flex items-center">
                ...
                <button
                  ...
                  className="absolute right-4 text-slate-500 hover:text-amber-500 transition-colors bg-transparent border-none outline-none cursor-pointer"
                >
        ...
        <motion.div initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }} className="text-center py-4 space-y-5">
          ...
          <button
            ...
            className="w-full rounded-xl bg-gradient-to-r from-[#FF9F00] to-[#FF6A00] py-3.5 text-xs font-black text-[#0B0D13] shadow-lg shadow-orange-500/10 hover:brightness-110 active:scale-[0.99] transition cursor-pointer border-none"
          >
            Go to Login
          </button>
        </motion.div>
